...
def dense_concat():
    layers = []
    layers.append(nn.Conv2d(640, 512, kernel_size=1, padding=0))
    layers.append(nn.Conv2d(1152, 1024, kernel_size=1, padding=0))
    layers.append(nn.Conv2d(640, 512, kernel_size=1, padding=0))
    layers.append(nn.Conv2d(352, 256, kernel_size=1, padding=0))
    return layers
