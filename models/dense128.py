...
def dense_conv2():
    ...
    layers.append(nn.MaxPool2d(kernel_size=2, stride=2, ceil_mode=True))
    layers.append(nn.MaxPool2d(kernel_size=2, stride=2, ceil_mode=True))
    layers.append(nn.Conv2d(512, 128, kernel_size=3, padding=1))
...
def dense_conv4():
    ...
    layers.append(nn.Upsa、mple(size=(38, 38), mode='bilinear'))
    layers.append(nn.MaxPool2d(kernel_size=2, stride=2, ceil_mode=True))
    layers.append(nn.Conv2d(512, 32, kernel_size=3, padding=1))    
    return layers
...
def dense_concat():
    ...
    layers.append(nn.Conv2d(1344, 1024, kernel_size=1, padding=0))
    layers.append(nn.Conv2d(704, 512, kernel_size=1, padding=0))
